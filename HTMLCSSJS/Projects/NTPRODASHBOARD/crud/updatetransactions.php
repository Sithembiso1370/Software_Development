...
// $my_f_Path = $explodedcolumns[0];
// $my_f = explode('/',$my_f_Path);
// $my_f_from_inp_path = explode("/",explode(",",$_REQUEST["tablecolumns"])[0])[0];
// $my_f_O = [];
// $my_f_O = explode('/',$my_f[0]);


// echo " colz to update at 0 = ".$explodedcolumns[0];
$username = "root";
$password = "";
