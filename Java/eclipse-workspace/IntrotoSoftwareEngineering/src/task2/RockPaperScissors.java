...
//        [0]scissors : Scissors beats paper
//        [1]rock : Rock beats scissors
//        [2]paper : Paper beats rock


//        System.out.println("comparison = " + number.compareTo(user_str));
//        TODO : 9 Scissors beats paper
        if (user_str > 2){
            System.out.println("Please follow the rules and enter a number between 0-2 not above!");
        }
        else if (user_str.equals(0) && number.equals(2)){
            System.out.println("!!!!!!you WIN !!!!!!! you chose Scissors and the  random chooser chose  paper");
        }
        //        TODO : 10 Rock beats scissors
        else if(user_str.equals(1) && number.equals(0)){
            System.out.println("!!!!!!you WIN !!!!!!! you chose Rock  and the  random chooser chose scissors");
        }
        //        TODO : 11 Paper beats rock
        else if(user_str.equals(2) && number.equals(1)){
            System.out.println("!!!!!!you WIN !!!!!!! you chose paper and the  random chooser chose rock");
        }
        //        TODO : 12 if user inputs random number generated
        else if(user_str.equals(number)){
            System.out.println("wow its actually a draw you chose "+user_str+" and the  random number is "+ number);
        }
        else {
            System.out.println("!!!!!!loose !!!!!!! you chose "+user_str+" and the  random number is "+ number);
        }
    }
