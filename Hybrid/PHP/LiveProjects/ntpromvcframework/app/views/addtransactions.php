...
<span class="menuIcon" id="menuIcon"></span>
        ...
        <div class="main" id="main">
            ...
            <div class="topsect" id="topsect">
                ...
                <div class="headerlabel" align="center"><h2>Add Transaction</h2></div>
...
window.addEventListener("load",()=>{
    ...
    console.log(phpvar_2_js_variable['usermodel'].length);
     ...
     for (let index = 0; index < 1; index++) {
        ...
        table += "<tr scope='col'>";
        table += "<td></td>";
        table += "<td><input type='text' placeholder=''></td>";
        table += "<td><input type='text' placeholder='Doc no:'></td>";
        table += "<td><input type='text' placeholder='NTPRO ID'></td>";
        table += "<td><input type='text' placeholder='Description'></td>";
        table += "<td><input type='text' placeholder='Client'></td>";
     ...
     for (let index = 0; index < 20; index++) {
        ...
        table += "<td>"+phpvar_2_js_variable['usermodel'][index]["client_name"] +"</td>";
        table += "<td><button class='Editbtn'>Edit</button></td>";
        table += "<td><button class='deletebtn'>Delete</button></td>";
        table += "</tr>"
     }
