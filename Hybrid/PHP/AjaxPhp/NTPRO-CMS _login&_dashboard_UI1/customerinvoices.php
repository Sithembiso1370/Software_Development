...
<html>
 ...
 <input type="checkbox" name="" id="check" />
  ...
  <div class="container" style="color: whitesmoke;" >
   <h3 style="padding-top: 5%;" align="center" >NTPRO Invoices</h3>
   <hr>
   <div class="card">
   ...
   <form method="POST" id="edit_image_form">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <input type="text" name="invoice_details" id="invoice_details" class="form-control" />
     </div>
     <div class="form-group">
...
$(document).ready(function(){
 ...
 $('#multiple_files').change(function(){
  ...
  {
   $.ajax({
    url:"uploadcustomerinvoices.php",
    method:"POST",
    data: form_data,
    contentType: false,
    cache: false,
 ...
 $(document).on('click', '.edit', function(){
  ...
  $.ajax({
   ...
   success:function(data)
   {
    ...
    $('#invoice_details').val(data.invoice_details);
 ...
 $(document).on('click', '.delete', function(){
  ...
  {
   $.ajax({
    url:"deletecustomerinvoices.php",
    method:"POST",
 ...
 $('#edit_image_form').on('submit', function(event){
  ...
  {
   $.ajax({
    url:"updatecustomerinvoices.php",
    method:"POST",
