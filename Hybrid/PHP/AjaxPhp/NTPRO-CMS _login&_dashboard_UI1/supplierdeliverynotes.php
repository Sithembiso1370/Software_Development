...
<html>
 <head>
  <title>supplier delivery notes</title>
 ...
 <input type="checkbox" name="" id="check" />
  ...
  <div class="container" style="color: whitesmoke;">
   <h3 style="padding-top: 5%;" align="center">Supplier Delivery-notes</h3>
   <hr>
   <div class="card">
  ...
  <div class="modal-content">
   <form method="POST" id="edit_image_form">
    ...
    <div class="form-group">
      ...
      <input type="text" name="deliverynote_name" id="deliverynote_name" class="form-control" />
     </div>
     <div class="form-group">
      <label>Invoice number</label>
      <input type="text" name="deliverynote_no" id="deliverynote_no" class="form-control" />
     </div>
     <div class="form-group">
      <label>items description</label>
      <input type="text" name="delivered_itemsdescription" id="delivered_itemsdescription" class="form-control" />
     </div>
     <div class="form-group">
    ...
    <div class="modal-footer">
     <input type="hidden" name="deliverynote_id" id="deliverynote_id" value="" />
...
$(document).ready(function(){
    ...
    {
    $.ajax({
    url:"fetchsupplierdeliverynotes.php",
    method:"POST",
 ...
 $('#multiple_files').change(function(){
  ...
  {
   $.ajax({
    url:"uploadsupplierdeliverynotes.php",
    method:"POST",
    data: form_data,
    contentType: false,
    cache: false,
 ...
 $(document).on('click', '.edit', function(){
  var deliverynote_id = $(this).attr("id");
  $.ajax({
   url:"editsupplierdeliverynotes.php",
   method:"post",
   ...
   success:function(data)
   {
    ...
    $('#deliverynote_id').val(deliverynote_id);
    $('#submitted_on').val(data.submitted_on);
    $('#deliverynote_name').val(data.deliverynote_name);
    $('#delivered_itemsdescription').val(data.delivered_itemsdescription);
    $('#s_qoute_reference').val(data.s_qoute_reference);
    $('#deliverynote_no').val(data.deliverynote_no);  
   }
  });
 }); 
 ...
 $(document).on('click', '.delete', function(){
  var deliverynote_id = $(this).attr("id");
  var deliverynote_name = $(this).data("deliverynote_name");
  if(confirm("Are you sure you want to remove it?"))
  {
   $.ajax({
    url:"deletesupplierdeliverynotes.php",
    method:"POST",
    data:{deliverynote_id:deliverynote_id,deliverynote_name:deliverynote_name},
    success:function(data)
    {
     load_image_data();
     alert("file removed");
 ...
 $('#edit_image_form').on('submit', function(event){
  ...
  {
   $.ajax({
    url:"updatesupplierdeliverynotes.php",
    method:"POST",
