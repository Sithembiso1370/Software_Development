...
<html>
 ...
 <input type="checkbox" name="" id="check" />
    ...
    <hr>
  <div class="container" style="color: whitesmoke !important;">
        <h3 style="padding-top: 5%;" align="center" >NTPRO Qoutes</h3>
        <hr>
        <div class="card">
