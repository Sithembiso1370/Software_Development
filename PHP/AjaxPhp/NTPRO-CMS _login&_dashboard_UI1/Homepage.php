...
<body class="">
        <div  class="sidebar" id="sidebar">
            <nav>
                ...
                >
                <a href="#"
                    ><i class="fas fa-shipping-fast fa-lg"></i><span>close</span></a
                >
            </nav>
        </div>
    <div class="main">
    ...
    <div class="projectsmain">
        ...
        <div align="center" class="transctionstable">
            ...
            <table align="center" class="table table-striped table-sm table-bordered table-responsive-sm table-active">
                ...
                <tbody id="mytbody">
                    <!-- <tr>
                        <td scope="row">28/09/2020</td>
                        <td>NT21809</td>
                        <td>Isanti</td>
                        <td>20004355 ON</td>
                        <td>waiting delivery</td>
                        <td>Other</td>
                    </tr>
                    <tr>
                        <td>28/09/2020</td>
...
// --------------------------------  Execute to get all active transactions and Display as table in Side Table View ----------------------------
    function getactivetransactions(openclosedparam) {
            ...
            xmlhttp.open("POST","fetch/fetchjoinrows.php?table=customer_qoutes&from="+from+ "&to="+to+"&openclosed="+openclosedparam ,true);
            xmlhttp.send();  
...
// 
        xmlhttp.open("POST","fetch/fetchcountsqissued.php?table=customer_qoutes&from="+from+ "&to="+to+"&openclosed="+openclosedparam ,true);
        xmlhttp.send();  
    }
...
// // --------------------------------  Execute to get all Quotes recieved ----------------------------
    ...
    function getquotesrecieved(openclosedparam) {
        ...
        xmlhttp.onreadystatechange = function() {
            ...
            xmlhttp.open("POST","fetch/fetchcountsqissued.php?table=supplier_qoutes&from="+from+ "&to="+to+"&openclosed="+openclosedparam ,true);
            xmlhttp.send();  
    }
...
//     // PURCHASE ORDERS
    function getpoissued(openclosedparam) {
        ...
        xmlhttp.open("POST","fetch/fetchcountsqissued.php?table=supplier_purchaseorders&from="+from+ "&to="+to+"&openclosed="+openclosedparam ,true);
        xmlhttp.send();  
    }
...
// // --------------------------------  Execute to get all Orders Recieved ----------------------------
    function getporecieved(openclosedparam) {
        ...
        xmlhttp.open("POST","fetch/fetchcountsqissued.php?table=customer_purchaseorders&from="+from+ "&to="+to+"&openclosed="+openclosedparam ,true);
        xmlhttp.send();  
    }
...
//     // INVOICES
    ...
    function getinvissued(openclosedparam) {
        ...
        xmlhttp.open("POST","fetch/fetchcountsqissued.php?table=customer_invoices&from="+from+ "&to="+to+"&openclosed="+openclosedparam ,true);
        xmlhttp.send();  
    }
    ...
    function getinvrecieved(openclosedparam) {
        ...
        xmlhttp.open("POST","fetch/fetchcountsqissued.php?table=supplier_invoices&from="+from+ "&to="+to+"&openclosed="+openclosedparam ,true);
        xmlhttp.send();  
    }
//     // F5.
// // --------------------------------  Execute to get all Orders Issued ----------------------------
//     // =======================================================================================================================================
    ...
    function getdnissued(openclosedparam) {
        ...
        xmlhttp.open("POST","fetch/fetchcountsqissued.php?table=customer_deliverynotes&from="+from+ "&to="+to+"&openclosed="+openclosedparam ,true);
        xmlhttp.send();   
    }
    ...
    function getdnrecieved(openclosedparam) {
        ...
        xmlhttp.open("POST","fetch/fetchcountsqissued.php?table=supplier_deliverynotes&from="+from+ "&to="+to+"&openclosed="+openclosedparam ,true);
        xmlhttp.send();   
    }
        // =======================================================================================================================================
