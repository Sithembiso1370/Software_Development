...
<html>
 <head>
  <title>Customer delivery notes</title>
 ...
 <input type="checkbox" name="" id="check" />
  ...
  <div class="container" style="color: whitesmoke;">
   <h3 style="padding-top: 5%;" align="center" >NTPRO Delivery-notes</h3>
   <hr>
   <div class="card">
  ...
  <div class="modal-content">
   <form method="POST" id="edit_image_form">
    <div class="modal-header">
     ...
     <h4 class="modal-title">Edit Delivery Note Details</h4>
    </div>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      <label>Deliverynote Number</label>
...
$(document).ready(function(){
 load_image_data(1);
    ...
    {
    $.ajax({
    url:"fetchcustomerdeliverynotes.php",
    method:"POST",
 ...
 $('#multiple_files').change(function(){
  ...
  {
   $.ajax({
    url:"uploadcustomerdeliverynotes.php",
    method:"POST",
    data: form_data,
    contentType: false,
    cache: false,
 ...
 $(document).on('click', '.edit', function(){
  ...
  $.ajax({
   url:"editcustomerdeliverynotes.php",
   method:"post",
 ...
 $(document).on('click', '.delete', function(){
  ...
  {
   $.ajax({
    url:"deletecustomerdeliverynotes.php",
    method:"POST",
 ...
 $('#edit_image_form').on('submit', function(event){
  ...
  {
   $.ajax({
    url:"updatecustomerdeliverynotes.php",
    method:"POST",
