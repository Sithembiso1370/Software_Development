...
<html>
 ...
 <input type="checkbox" name="" id="check" />
  ...
  <div class="container" style="color: whitesmoke;">
   <h3 style="padding-top: 5%;" align="center">Issued Purchase-Orders</h3>
   <hr>
   <div class="card">
            <div class="card-header">Dynamic Transaction Data</div>
                <div class="card-body">
                    ...
                    <div style="padding:0 15% 0 10% ;"  align="center" class="form-group" style="width: 30%;">
   ...
   <form method="POST" id="edit_image_form">
    ...
    <div class="modal-body">
     ...
     <div class="form-group">
      ...
      <input type="text" name="expecteddeliverydate" id="expecteddeliverydate" class="form-control" />
     </div>
    </div>
...
$(document).ready(function(){
    ...
    {
    $.ajax({
    url:"fetchsupplierpurchaseorders.php",
    method:"POST",
 ...
 $('#multiple_files').change(function(){
  ...
  {
   $.ajax({
    url:"uploadsupplierpurchaseorders.php",
    method:"POST",
    data: form_data,
    contentType: false,
    cache: false,
 ...
 $(document).on('click', '.edit', function(){
  ...
  $.ajax({
   url:"editsupplierpurchaseorders.php",
   method:"post",
 ...
 $(document).on('click', '.delete', function(){
  ...
  {
   $.ajax({
    url:"deletesupplierpurchaseorders.php",
    method:"POST",
    data:{purchaseorder_id:purchaseorder_id, order_name:order_name},
    success:function(data)
    {
     load_image_data();
     alert("file removed");
 ...
 $('#edit_image_form').on('submit', function(event){
  ...
  {
   $.ajax({
    url:"updatesupplierpurchaseorders.php",
    method:"POST",
