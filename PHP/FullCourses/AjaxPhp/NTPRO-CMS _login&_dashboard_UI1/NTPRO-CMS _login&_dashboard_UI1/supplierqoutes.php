...
<html>
 ...
 <input type="checkbox" name="" id="check" />
  ...
  <div class="container" style="color: whitesmoke;">
   <h3 style="padding-top: 5%;" align="center" style="background-color: rgba(245, 245, 245, 0.363);" style="color: whitesmoke;">Supplier Qoutes</h3>
   <hr>
        <div class="card" >
   ...
   <form method="POST" id="edit_image_form">
    ...
    <div class="modal-body">
     <div class="form-group">
      ...
      <input type="text" name="qoute_name" id="qoute_name" class="form-control" />
     </div>
     <div class="form-group">
      <label>Qoute Number</label>
      <input type="text" name="qoute_no" id="qoute_no" class="form-control" />
     </div>
     
     <div class="form-group">
      <label>NTPRO ID</label>
      <input type="text" name="s_qoute_reference" id="s_qoute_reference" class="form-control" />
     </div>
     <div class="form-group">
      <label>qoute_items</label>
      <input type="text" name="qoute_items" id="qoute_items" class="form-control" />
     </div>
     <div class="form-group">
...
$(document).ready(function(){
 ...
 $(document).on('click', '.edit', function(){
  var qoute_id = $(this).attr("id");
  $.ajax({
   url:"editsupplierqoutes.php",
   method:"post",
   ...
   success:function(data)
   {
    ...
    $('#qoute_name').val(data.qoute_name);
    $('#s_qoute_reference').val(data.s_qoute_reference);
    $('#qoute_items').val(data.qoute_items);
    $('#supplier_name').val(data.supplier_name);
    $('#qoute_no').val(data.qoute_no);
 ...
 $(document).on('click', '.delete', function(){
  var qoute_id = $(this).attr("id");
  var qoute_name = $(this).data("qoute_name");
  if(confirm("Are you sure you want to remove it?"))
  {
   $.ajax({
    url:"deletesupplierqoutes.php",
    method:"POST",
    data:{qoute_id:qoute_id, qoute_name:qoute_name},
    success:function(data)
    {
     load_image_data();
     alert("file removed");
